...
export const handler = (async argv => {
    ...
    if (argv.assets) {
        ...
        console.log('=== cdn_project_pathname: %o', cdn_project_pathname);
        ...
        // let list;
        // try {
        //     list = await asyncTask('Listing files', backoffice.api.listFiles(cdn_project_pathname, ''));
        // } catch (ex) {
        //     console.log(ex);
        // }
        ...
        // const lets_upload_this = assets2deploy[0].absolutePath;
        // const mime_type = mime.getType(lets_upload_this);
        // const result = await backoffice.api.uploadFile('content/no-such-folder',
        //     new Blob([fs.readFileSync(lets_upload_this)], { type: mime_type }),
        //     'a-file.jpg', (progress) => {
