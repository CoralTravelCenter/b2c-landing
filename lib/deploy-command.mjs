...
export const handler = (async argv => {
    ...
    if (argv.extend) {
        ...
        const pageContent = await backoffice.inquirePageVersion();
        ...
        // await upsertContentWidgets(backoffice.api, landingName, pageDescriptor, deploymentDescriptor, pageContent);
